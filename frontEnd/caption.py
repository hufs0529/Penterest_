...
# # 버킷명
# BUCKET_NAME = 'penterest'  
# # 객체명
# OBJECT_NAME = 'gifs/sp_smdm_xgb.model' 
# # 파일을 저장할 위치, AWS Lambda에서는 오직 /tmp 에만 파일을 작성할 수 있다.
# FILE_NAME = '/tmp/sp_smdm_xgb.model' 

# s3 = boto3.client('s3')
# s3.download_file(BUCKET_NAME, OBJECT_NAME, FILE_NAME)
# gif = 'https://penterest.s3.ap-northeast-2.amazonaws.com/gifs/sample.gif'
...
def inference(gif, model_name):
  ...
  #image = imageio.imread(img, format = 'GIF')
...
#print(inference("https://penterest.s3.ap-northeast-2.amazonaws.com/gifs/sample.gif","COCO"))