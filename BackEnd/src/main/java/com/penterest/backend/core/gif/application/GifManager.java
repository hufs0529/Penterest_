package com.penterest.backend.core.gif.application;

import com.penterest.backend.core.gif.domain.GifBoard;
import com.penterest.backend.core.gif.infrastructure.GifRepository;
